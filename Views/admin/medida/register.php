...
<CENTER> <H2 style="width: 400px; color: #806B39;"> REGISTRO DE MEDIDAS </H2> </CENTER> 
  ...
  <div class="row" style="padding: 20px; ">
   ...
   <!--  <div class="section">
    ...
    <div class="col-md-4 " style="border:solid 1ex #C5BA90; padding: 40px; border-radius: 2em; margin-left: 200px; border-right: none; 
                                    background-color: #806B39;">
    <div style="  ">
     <a class="btn  btn-sm" href="../inicio.php" style="background-color: #C5BA90; color: white;">Inicio  </a>
     <a class="btn  btn-sm" href="../pedido/register.php" style="background-color: #C5BA90; color: white;">Registrar Pedido </a>
     <a class="btn  btn-sm" href="../medida/register.php" style="background-color: #C5BA90; color: white;">Registrar Medidas </a>
     <a class="btn  btn-sm" href="" style="background-color: #C5BA90; color: white;">Historial  </a>
    </div>

    <div class="col-md-4 "  style="border:solid 1ex #C5BA90; padding: 40px; border-radius: 2em; border-left: none; 
                                        background-color:  #806B39;">
      <center><h3>MEDIDAS</h3></center> <hr>
      ...
      <!--  -->       
      <input type="submit" name="" class="btn btn-lg" style="background-color:  #C5BA90; color: white;" value="Registrar">
    </div>
